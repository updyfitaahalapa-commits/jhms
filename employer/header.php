...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="mb-2 <?php echo basename($_SERVER['PHP_SELF']) == 'post_job.php' ? 'active' : ''; ?>">
            ...
            <li class="mb-2 <?php echo basename($_SERVER['PHP_SELF']) == 'view_applicants.php' ? 'active' : ''; ?>">
                <a href="view_applicants.php"><i class="fas fa-users-viewfinder"></i> Manage Applicants</a>
            </li>
